...
export class AuthController {
  ...
  getFirebaseProfile(@Request() req) {
    return {
  ...
  @Post('firebase/sync')
  @UseGuards(FirebaseAuthGuard)
  async syncFirebaseUser(@Request() req, @Body() profile: FirebaseSyncDto) {
    return this.firebaseService.syncUser(req.firebaseUser, profile);
  }
